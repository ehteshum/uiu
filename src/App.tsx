...
import { Facebook, PlusCircle, Trash2, Calculator, GraduationCap, Code2, RefreshCw, X } from 'lucide-react';
...
const App: React.FC = () => {
  const [completedCredit, setCompletedCredit] = useState<number>();
      ...
      <div className="max-w-3xl mx-auto">
        ...
        {showResults && (
          ...
          >
            ...
            <div 
              className={`relative bg-gray-900 p-6 rounded-lg w-full max-w-2xl transform transition-all duration-300 ${
                isModalClosing 
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-gray-800/80 backdrop-blur-sm p-4 rounded-lg transform hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/20">
